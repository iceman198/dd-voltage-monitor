...
lines_to_keep = 20000;
lines_to_avg = 12; #each line is 5 seconds...12 will do groups of 1min....72 will do groups of 5min
...
def get_history():
    ...
    while(n > 0):
        ...
        i = i + 1;
        if (((i > lines_to_avg * 12) and (n > my_portion)) or ((i > lines_to_avg) and (n <= my_portion)) or (n <= 1)):
